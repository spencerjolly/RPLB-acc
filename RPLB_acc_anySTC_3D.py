...
@jit(nopython=True)
def RPLB_acc_anySTC_3D(lambda_0, tau_0, w_00, P, Psi_0, spec_phase_coeffs, LC_coeffs, SC_coeffs, g_0, t_0, z_0, x_0, y_0, beta_0):
